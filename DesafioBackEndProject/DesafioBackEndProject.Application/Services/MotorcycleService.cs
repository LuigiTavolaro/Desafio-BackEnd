...
namespace DesafioBackEndProject.Application.Services
{
    public class MotorcycleService : IMotorcycleService
    {
        ...
        {
            var moto = await _motoRepository.GetByPlateAsync(plate);
        ...
        public async Task<int> AddAsync(MotorcycleCreateDto motoDto)
        {
            ...
            var motorcycleByPlate = await _motoRepository.GetByPlateAsync(moto.Plate ?? string.Empty);
        ...
        {
            await _motoRepository.UpdatePlateAsync(id, newPlate);
        }
